...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('temp_reservation_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('reservation_id');
            $table->foreign('reservation_id')->references('id')->on('temp_reservations')->onDelete('cascade');
            $table->double('price');
    ...
    {
        Schema::dropIfExists('temp_reservations_details');
    }
};
