...
@section('title', 'Crete New Vehicle')

@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Crete New Vehicle</h1>
            </div>

            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Home</a></li>
                    <li class="breadcrumb-item active">Crete New Vehicle</li>
                </ol>
            </div>
        </div>
    </div>
                            ...
                            <form action="{{ route('admin.vehicle-types.store') }}" method="POST"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('capacity_of_passenger') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('max_allowed_seats') }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                id="no_of_luggage" name="no_of_luggage" value="{{ old('no_of_luggage') }}"
                                                required>
                                            @error('no_of_luggage')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    {{-- <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('per_mile_charge') }}" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('rush_hour_charge') }}" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="hourly_charge" name="hourly_charge" value="{{ old('hourly_charge') }}"
                                                required>
                                            @error('hourly_charge')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('miles_under_10') }}" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('first_15_miles') }}" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('after_15_miles') }}" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('hourly_charge') }}" required>
                                            @error('hourly_charge')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('tax') is-invalid @enderror"
                                                id="tax" name="tax" value="{{ old('tax') }}" required>
                                            @error('tax')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('minimum_hours') }}" required>
                                            @error('minimum_hours')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 img-card-cont">
                                        <img class="img-fluid" id="thumbimgpre" width="50%" height="50%">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
